...
def TrainML(request):
    if request.method == 'GET':
        ...
        return render(request, 'html/UserScreen.html', context)
...
def index(request):
    return render(request, 'html/index.html', {'data': '', 'img': ''})   
...
def home(request):
    return HttpResponse("Welcome to the Blood Group Prediction System") 
